//! The Brown invariant of a `Z/4`-valued quadratic refinement.
//!
...
//!
//! # Relation to characteristic-two metrics
//!
...
//! `b_ii = q_i mod 2`. [`double_f2`] maps an ordinary `F₂` quadratic form
//! `q'` to `2q' : V → Z/4` and satisfies
//!
//! ```text
...
//! reported with the radical data. [`DiscriminantForm::brown_invariant`] provides
//! the corresponding finite-quadratic-module computation.
...
mod tests {
    ...
    /// Exact Gauss-sum implementation used to verify the reduction algorithm.
    ...
    #[test]
    fn reduction_matches_enumeration_at_rank_26() {
        // Rank 26 remains feasible for the independent enumeration check.
        let q4 = vec![1u128; 26];
    ...
    #[test]
    fn brown_f2_reduces_rank_40_without_enumeration() {
        // Orthogonal reduction handles rank 40 without enumerating all vectors.
        let q4 = vec![1u128; 40];
