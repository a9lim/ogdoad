...
print("  F₃ <1,1> :", pl.classify_finite_odd(3, [1, 1]))   # disc 1 = square
print("  F₃ <1,2> :", pl.classify_finite_odd(3, [1, 2]))   # disc 2 = nonsquare
print("  Hasse always +1 over a finite field:", pl.hasse_invariant_finite_odd(5, [1, 2, 3, 4]))
print("  finite odd helper package     :", pl.classify_finite_odd(3, [1, 2]).display(),
      pl.finite_odd_witt(5, [1, 2]), pl.hilbert_symbol(5, 2, 3),
      pl.is_square_finite(7, 2))
f9_stair = pl.e_staircase_finite_odd(3, [1, 1], degree=2)
print("  F₉ BW/e-staircase helpers    :", pl.bw_class_finite_odd(3, [1, 1], degree=2),
...
g3 = pl.finite_odd_witt(3, [1]); zero3 = pl.finite_odd_witt(3, [])
print("  W(F₃) is ℤ/4 :", g3 + g3 != zero3, "and", g3 + g3 + g3 + g3 == zero3)
g5, h5 = pl.finite_odd_witt(5, [1]), pl.finite_odd_witt(5, [2])
print("  W(F₅) is ℤ/2×ℤ/2 :", g5 + g5 == pl.finite_odd_witt(5, []) and h5 + h5 == pl.finite_odd_witt(5, []))
...
print("  char-2 Rust-name helpers     :", pl.arf_nimber(n2a).arf,
      pl.arf_fpn_char2([0, 0], {(0, 1): 3}, degree=3).arf,
      pl.isometric_fpn_char2(f8h, pl.Char2FiniteFieldForm([0, 0], {(0, 1): 1}, degree=3)),
...
print("  F₅ disc / F₄ AS class        :", pl.discriminant_finite_odd(5, [1, 2]),
...
stair = pl.e_staircase_finite_odd(5, [1, 2, 3])
...
print("  BW(F_3) of ⟨1⟩:", pl.bw_class_finite_odd(3, [1]), "(order-4 graded part ≅ W(F_3))")
...
print("  is_isometric ⟨1,1⟩≅⟨2,3⟩ over F₅ :", pl.isometric_finite_odd(5, [1, 1], [2, 3]))
...
ow5 = pl.witt_decompose_finite_odd(5, [1, 1])
ow3 = pl.witt_decompose_finite_odd(3, [1, 1])
