...
problem (\texttt{tasks/OPEN.md} Problem~3 of \texttt{ogdoad}): the exact
...
Brauer-invariant bridge (Bridge~K, \path{tasks/TBD.md}) requires for
...
\texttt{README.md}, and \texttt{tasks/OPEN.md} were updated in step. The full
