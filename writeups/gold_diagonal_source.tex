...
case. By itself it does not turn those constants into a normal-play rule; the
companion weighted-source Witt--FIFO theorem in
\texttt{writeups/goldarf.tex} supplies that separate strategic step.
\end{abstract}
...
essential even though the combined project-level problem is now resolved.
...
\section{Consequence for the resolved Gold-game program}
...
The strategic layer is resolved separately by weighted-source Witt--FIFO. Its
