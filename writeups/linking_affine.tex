...
least-counterexample witness choice $y\mapsto z_y$ need not even preserve the
odd routing set $Y$; functional-digraph cycle parity cannot be applied without
a new closure theorem.
...
\item \PROVED{} The interval/disjointness reduction, vector live-star identity,
      ...
      front-signature no-go, pass-free reversal identity, and its local causal
