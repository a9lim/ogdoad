...
not cover. The live question is no longer existence but \emph{semantics}:
recast the charge readout into normal/misère/loopy outcome classes (or
prove the recasting impossible), and settle the even-$a$ diagonal lemma.
...
\item \emph{Recasting and mechanism reconciliation} (highest leverage):
recast the $\sigma$-valued charge readout into normal/misère/loopy
outcome semantics -- or prove the recasting impossible; derive the
\textsc{fifo}+dummy reduced-game facts and re-run the extraspecial
support-counting argument under \textsc{fifo} discipline to explain
\emph{why} the queue-plus-tempo discipline defeats adversarial unlinking.
