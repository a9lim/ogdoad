...
transition-system proof of the both-seat matching strategy and its public-
matching construction parameterized over every edge-deleted submatching. The
q-blind single-policy and per-close trace observations use the visible move
branches of that construction but are not separately reified Lean predicates.
