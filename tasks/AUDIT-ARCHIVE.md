...
the adjacent `__mul__` docstring and the AGENTS/tasks claims.
...
| **docs-claims** | README, tasks/{DONE,TBD}, OPEN, writeups/RESEARCH-EXCESS, TABLES, `writeups/goldarf.tex` | **NOT AUDITED** — reviewer died (API socket error); left as a gap by decision |
