...
| Weyl pillar | carry out the transformation/symbol, modular-representation, and certified D-module waves in [`WEYL.md`](WEYL.md), preserving finite-support, characteristic, and budget boundaries at every layer |
