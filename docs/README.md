...
| [`OPEN.md`](OPEN.md) | the three live mathematical problems and their exact frontiers |
| [`ROADMAP.md`](ROADMAP.md) | unfinished engineering and publication work |
| [`WEYL.md`](WEYL.md) | Weyl-pillar architecture, staged implementation plan, and completion criteria |
